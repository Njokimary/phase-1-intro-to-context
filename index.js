...
const employeeData = [
  ...
  ["John", "Doe", "Developer", 2],
  ["Jane", "Smith", "Designer", 3]
];

// Test the functions with sample data
const employeeRecords = createEmployeeRecords(employeeData);
createTimeInEvent(employeeRecords[0], "2023-08-07 09:00");
createTimeOutEvent(employeeRecords[0], "2023-08-07 17:00");
//  print the total payroll burden for all employees
